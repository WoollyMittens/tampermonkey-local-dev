...
This TamperMonkey script compiles the .less files in a local Mura or Magento repository and see the result on a production or staging server immediately without the need for a local database or working dev environment.
